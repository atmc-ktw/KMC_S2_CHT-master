...
{
    public partial class ATbEdtFindEllipse : Form
    {
        private AFindEllipse m_aFindEllipse = null;
        ...
        // 2014.03.27
        private AIniFindEllipse m_aIni = null;
        ...
        public ATbEdtFindEllipse(int nType, int nPoint, int nToolIndex)
        {
            InitializeComponent();
            ...
            // 2016.07.29
            if (m_aPoint.GetToolCount("FindEllipse") > m_nToolIndex)
            {
                m_aFindEllipse = m_aPoint.GetTool("FindEllipse", m_nToolIndex) as AFindEllipse;
            }
            else
            {
                m_aFindEllipse = new AFindEllipse();

                m_aFindEllipse.Name = AVisionProBuild.MakeName("FindEllipse", DateTime.Now);
                m_aPoint.Add("FindEllipse", m_aFindEllipse);
            }

            cogFindEllipseEditV2.Subject = m_aFindEllipse.GetTool();

            InitLanguage();
            InitializeFindEllipse();
        }
        ...
        private void ATbEdtFindEllipse_FormClosed(object sender, FormClosedEventArgs e)
        {
            tmrLive.Enabled = false;
            tmrTime.Enabled = false;

            // 2017.01.09
            cogFindEllipseEditV2.Subject = null;

            // 2015.03.17
            cogFindEllipseEditV2.Dispose();
        ...
        {
            // 2016.11.20
            //m_aFindEllipse.InputImage = m_aPoint.RunCalibImage(InputImage, m_aIni.CalibCase);
            m_aFindEllipse.InputImage = InputImage;
        }
