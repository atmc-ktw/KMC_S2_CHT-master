...
{
    public partial class AFrmPMAlign : Form
    {
        ...
        public AFrmPMAlign(int nType, int nPoint, int nToolIndex)
        {
            InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else if (m_emRegionWorkType == _emRegionWorkType.TrainRegion)
            {
                ...
                // 2014.07.30
                //m_aPMAlign.LastRunRecordDiagEnable = CogPMAlignLastRunRecordDiagConstants.ResultsMatchFeatures | CogPMAlignLastRunRecordDiagConstants.InputImageByReference;
            }
        ...
        */
        ...
        // 2011.10.31
        private void AFrmPMAlign_FormClosed(object sender, FormClosedEventArgs e)
        {
            tmrLive.Enabled = false;
